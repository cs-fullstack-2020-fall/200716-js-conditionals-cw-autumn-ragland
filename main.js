...
} else if (userNum < 0) {// Otherwise print [NUMBER] is negative.
...
// If the sum of those two numbers is even alert the user The sum of [FIRST NUMBER] and [SECOND NUMBER] is even.
if (userSum % 2 == 0) {
...
if (userWord1 == userWord2 && userWord1 != secretWord) {
    ...
    console.log("You got in but only bc your words matched");
